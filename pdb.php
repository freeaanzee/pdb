	...
	class Participants_Database {
		...
		public static function activate_plugin() {
			if ( ! is_plugin_active('contact-form-7/wp-contact-form-7.php') or ! is_plugin_active('contact-form-7-to-database-extension/contact-form-7-db.php') ) {
				...
				add_option( 'pdb_drinks', array( 'Bloody Mary', 'Chimoncello', 'Pornstar Martini', 'Sex On The Beach' ) );
				add_option( 'pdb_reasons', array( 'Adriaan Clynckemaillie', 'Bart De Pauw', 'Erik Van Looy', 'Fien Germyns', 'Herman Van Molle' ) );
			}
		}
